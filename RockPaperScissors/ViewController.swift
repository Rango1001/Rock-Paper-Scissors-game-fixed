...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func startCountdown() {
        ...
        playerChoisePickerView.isUserInteractionEnabled = false
        playerChoisePickerView.alpha = 0.5
        difficultySegmentedControl.isEnabled = false
        difficultySegmentedControl.alpha = 0.5
    ...
    @objc func updateCountdown() {
        if countdown > 0 {
            ...
            playerChoisePickerView.isUserInteractionEnabled = true
            playerChoisePickerView.alpha = 1
            difficultySegmentedControl.isEnabled = true
            difficultySegmentedControl.alpha = 1
